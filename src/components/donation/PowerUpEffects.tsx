    ...
    return (
        <Card className="p-6 relative overflow-hidden border-none shadow-sm">
            <div className="absolute -top-6 -right-6 opacity-5">
                <Zap size={120} className="text-[var(--color-accent-purple)] fill-[var(--color-accent-purple)]" />
            </div>
            <div className="flex items-center gap-2 mb-4">
                <div className="w-8 h-8 rounded-full bg-[var(--color-pastel-purple)] flex items-center justify-center">
                    <Zap size={14} className="text-[var(--color-deep-purple)] fill-[var(--color-deep-purple)]" />
                </div>
