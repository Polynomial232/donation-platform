                ...
                {perks.map((perk, idx) => (
                    ...
                    >
                        <div className="flex items-center gap-3">
                            <div className={`w-8 h-8 rounded-lg flex items-center justify-center border ${perk.bgColor} ${perk.borderColor}`}>
                                {perk.icon}
                            </div>
                            <div>
                                <p className="text-[10px] font-bold text-slate-400 uppercase tracking-wide">{perk.amount}</p>
