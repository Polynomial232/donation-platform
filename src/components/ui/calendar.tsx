...
function Calendar({
  ...
  const defaultClassNames = {
    ...
    month: "w-full",
    month_caption: "relative mb-2 flex h-9 items-center justify-center text-base font-semibold ",
    ...
    day: "text-center",
    range_start: "rounded-l-full bg-black text-white dark:bg-white dark:text-black shadow-md",
    range_end: "rounded-r-full bg-black text-white dark:bg-white dark:text-black shadow-md",
    range_middle: "bg-black/10 text-foreground dark:bg-white/20 rounded-none transition-colors",
    today:
    ...
    outside: "text-muted-foreground/50 hover:text-accent-foreground hover:bg-accent/30",
    hidden: "invisible",
