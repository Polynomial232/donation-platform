        ...
        <div className="min-h-screen flex items-center justify-center bg-[var(--color-off-white)] p-4">
            <div className="w-full max-w-md space-y-6">
                <div className="text-center space-y-2">
                    ...
                    <p className="text-slate-500 font-medium text-sm">Start earning from your content today.</p>
                </div>
                    ...
                    <form className="space-y-4">
                        ...
                        <div className="space-y-1">
                            ...
                            <input
                                ...
                                placeholder="••••••••"
                            />
                            <p className="text-[10px] text-slate-400 font-medium">Must be at least 8 characters.</p>
                        </div>
                ...
                <p className="text-center text-sm font-medium text-slate-500">
                    Already have an account? <Link href="/login" className="text-[var(--color-deep-purple)] font-bold">Sign in</Link>
                </p>
            </div>
        </div>
    );
