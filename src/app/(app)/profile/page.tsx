  ...
  return (
    <main className="min-h-screen bg-[var(--color-off-white)] pb-12">
      <div className="max-w-md mx-auto px-4 space-y-8">
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <Button
              variant="ghost"
              size="sm"
              className="text-[var(--color-deep-purple)] px-0 font-bold h-auto mt-1 hover:bg-transparent"
            >
              Edit Profile
            </Button>
          </div>
        ...
        <div className="space-y-4">
          ...
          <Card className="border-none shadow-sm divide-y divide-slate-50 overflow-hidden">
            ...
            <Link href="#" className="block hover:bg-slate-50 transition-colors">
              <div className="p-4 flex items-center justify-between">
                <div className="flex items-center gap-3">
                  <div className="w-5 h-5 flex items-center justify-center font-bold text-slate-500 text-xs border rounded">
                    $
                  </div>
        ...
        <Button
          variant="outline"
          className="w-full rounded-xl text-red-500 hover:text-red-600 hover:bg-red-50 border-red-100 font-bold gap-2"
        >
          <LogOut size={16} />
          Sign Out
        </Button>
