...
export default function ExplorePage() {
  ...
  const filteredCreators = allCreators.filter((creator) => {
    ...
    const matchesCategory =
      ...
      (selectedCategory === "Artists" && creator.category === "Artist");
                      ...
                      <div className="p-4 flex-1">
                        <div className="flex items-start justify-between">
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              <h3 className="font-bold text-sm text-slate-900 group-hover:text-[var(--color-deep-purple)] transition-colors">
                                {creator.username}
                              </h3>
              ...
              <div className="flex items-center justify-between mb-4">
                <div>
                  ...
                  <p className="text-[11px] text-slate-400 font-medium">
                    ...
                    <span className="text-[var(--color-deep-purple)] font-bold">Art & Design</span>
                  </p>
                </div>
              </div>
                ...
                {recommendedCreators.map((creator, idx) => (
                  <Link href={`/${creator.username}`} key={idx} className="block group">
                    <div className="bg-white shadow-[0_10px_25px_-5px_rgba(0,0,0,0.02),0_8px_10px_-6px_rgba(0,0,0,0.02)] rounded-[24px] p-4 flex flex-col items-center text-center cursor-pointer hover:shadow-md transition-all h-full">
                      ...
                      <h3 className="font-bold text-xs text-slate-900 group-hover:text-[var(--color-deep-purple)] transition-colors">
                        {creator.username}
                      </h3>
