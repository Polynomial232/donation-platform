        ...
        <main className="min-h-screen bg-[var(--color-off-white)] pb-12">
            <div className="max-w-2xl mx-auto px-4 mt-8 space-y-6">
                <div className="flex justify-between items-center">
                    ...
                    <Button variant="outline" size="sm" className="rounded-xl"><Settings size={16} /></Button>
                </div>
                ...
                <Card className="p-6 border-none shadow-sm text-center py-12 space-y-4">
                    ...
                    <p className="text-sm text-slate-500 max-w-xs mx-auto">You have no pending notifications or critical alerts at the moment.</p>
                </Card>
                ...
                <Card className="divide-y divide-slate-50 border-none shadow-sm overflow-hidden">
                    <div className="p-4 flex items-center justify-between hover:bg-slate-50">
                        <div className="flex items-center gap-3">
                            <div className="bg-slate-100 p-2 rounded-lg"><BellRing size={16} className="text-slate-600" /></div>
                            <span className="text-sm font-bold text-slate-700">Push Notifications</span>
                        </div>
                        <div className="w-10 h-6 bg-[var(--color-accent-yellow)] rounded-full relative cursor-pointer"><div className="absolute right-1 top-1 w-4 h-4 bg-white rounded-full shadow-sm"></div></div>
                    </div>
                    <div className="p-4 flex items-center justify-between hover:bg-slate-50">
                        <div className="flex items-center gap-3">
                            <div className="bg-slate-100 p-2 rounded-lg"><Volume2 size={16} className="text-slate-600" /></div>
