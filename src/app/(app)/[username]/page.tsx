...
async function getCreator(username: string) {
    ...
    return {
        ...
        description: "Halo guys! Dukung aku untuk upgrade PC biar bisa streaming game AAA dengan lancar ya. Setiap dukungan kalian sangat berarti buat perkembangan channel ini. Terima kasih banyak supportnya! 🚀",
...
export default async function CreatorPage({ params }: { params: Promise<{ username: string }> }) {
    ...
    const progressPercentage = Math.min(100, Math.round((creator.currentAmount / creator.goalAmount) * 100));
