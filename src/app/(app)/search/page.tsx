...
const allCreators = [
    { username: "Kaira Arcsladivya", category: "Musician", avatar: "https://i.imgur.com/1Z3MVNG.jpeg", bio: "Creating cozy lofi beats for your study sessions ✨" },
    { username: "Pixel Wizard", category: "Artist", avatar: "https://i.imgur.com/1Z3MVNG.jpeg", bio: "Pixel art and retro game assets creator." },
    { username: "NightRider_TV", category: "Gamer", avatar: "https://i.imgur.com/1Z3MVNG.jpeg", bio: "Professional racer and variety streamer. 🏁" },
    { username: "Studio Ghibly Vibes", category: "Artist", avatar: "https://i.imgur.com/1Z3MVNG.jpeg", bio: "Drawing daily landscapes and cozy rooms." },
];
...
export default function SearchPage() {
    ...
    const filteredCreators = allCreators.filter((creator) => {
        ...
        const matchesCategory = selectedCategory === "All Creators" || creator.category + "s" === selectedCategory || creator.category === selectedCategory || (selectedCategory === "Artists" && creator.category === "Artist"); // Simple plural handling
            ...
            <nav className="sticky top-0 z-50 bg-white/90 backdrop-blur-md px-4 py-3 border-b border-slate-50">
                <div className="flex items-center justify-between mb-4">
                    <div className="flex items-center gap-2">
                        <div className="w-7 h-7 bg-[var(--color-accent-yellow)] rounded-lg flex items-center justify-center text-[var(--color-deep-purple)] font-black text-sm">D</div>
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div className="w-8 h-8 rounded-full overflow-hidden bg-slate-200 border border-slate-100">
                            <Image src="https://i.imgur.com/1Z3MVNG.jpeg" alt="User" width={32} height={32} className="object-cover" />
                        </div>
                    </div>
                </div>
