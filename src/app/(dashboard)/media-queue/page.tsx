    ...
    return (
        <div className="space-y-6">
            ...
            <Card className="p-6 border-none shadow-sm bg-slate-900 text-white relative overflow-hidden">
                ...
                <div className="relative z-10 flex flex-col md:flex-row gap-6 items-center">
                    <div className="w-full md:w-64 aspect-video bg-black rounded-xl border border-white/10 flex items-center justify-center relative overflow-hidden group">
                        <img src="https://img.youtube.com/vi/dQw4w9WgXcQ/maxresdefault.jpg" className="w-full h-full object-cover opacity-60" />
                    ...
                    <div className="flex-1 space-y-4 w-full">
                        <div>
                            ...
                            <p className="text-slate-400 text-sm">Requested by <span className="text-white font-bold">Budi01</span> • Rp 10.000</p>
                        </div>
                        ...
                        <div className="flex gap-2">
                            <Button className="bg-white/10 hover:bg-white/20 text-white border-none"><Pause size={18} /></Button>
                            <Button className="bg-white/10 hover:bg-white/20 text-white border-none"><SkipForward size={18} /></Button>
                            <Button className="bg-white/10 hover:bg-white/20 text-white border-none"><RefreshCw size={18} /></Button>
            ...
            <div className="space-y-3">
                {[1, 2, 3].map((i) => (
                    <Card key={i} className="p-4 flex items-center gap-4 border-none shadow-sm hover:shadow-md transition-shadow">
                        ...
                        <div className="w-16 h-10 bg-slate-200 rounded-lg overflow-hidden flex-shrink-0 relative">
                            {i % 2 === 0 ? (
                                <div className="w-full h-full bg-indigo-100 flex items-center justify-center"><Volume2 size={16} className="text-indigo-500" /></div>
                            ) : (
                                <img src={`https://img.youtube.com/vi/dQw4w9WgXcQ/${i}.jpg`} className="w-full h-full object-cover" />
                            )}
                        </div>
                        <div className="flex-1 min-w-0">
                            ...
                            <p className="text-xs text-slate-500">
                                {i % 2 === 0 ? "Soundboard" : "Mediashare"} • <span className="font-bold text-slate-700">Siti_G</span>
                            </p>
                        </div>
                        <div className="flex items-center gap-1">
                            <Button variant="ghost" size="sm" className="h-8 w-8 p-0 rounded-lg text-slate-400 hover:text-[var(--color-deep-purple)]"><MoveUp size={16} /></Button>
                            <Button variant="ghost" size="sm" className="h-8 w-8 p-0 rounded-lg text-slate-400 hover:text-red-500"><Trash2 size={16} /></Button>
                        </div>
                    </Card>
                ))}
            </div>
