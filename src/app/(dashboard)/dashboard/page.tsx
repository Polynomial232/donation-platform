        ...
        <div className="space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <Card className="p-6 border-none shadow-sm flex flex-col gap-4">
                    <div className="flex justify-between items-start">
                        <div>
                            ...
                            <h3 className="text-2xl font-black text-slate-900 mt-1">{formatCurrency(data.balance)}</h3>
                        </div>
                ...
                <Card className="p-6 border-none shadow-sm flex flex-col gap-4">
                    <div className="flex justify-between items-start">
                        <div>
                            ...
                            <h3 className="text-2xl font-black text-green-600 mt-1">{formatCurrency(data.todaysRevenue)}</h3>
                        </div>
                ...
                <Card className="p-6 border-none shadow-sm flex flex-col gap-4">
                    <div className="flex justify-between items-start">
                        <div>
                            <p className="text-xs font-bold text-slate-400 uppercase tracking-wider">Active Supporters</p>
                                ...
                                {paginatedTransactions.length > 0 ? (
                                    paginatedTransactions.map((transaction) => (
                                        <tr key={transaction.id} className="hover:bg-slate-50/50 transition-colors">
                                            ...
                                            <td className={`px-6 py-4 font-bold ${transaction.type === 'income'
                                            ...
                                            <td className="px-6 py-4 text-slate-400 font-medium">{formatTime(transaction.time)}</td>
                                        </tr>
                                    ))
                                ) : (
                                    <tr>
