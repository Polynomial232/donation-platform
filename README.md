...
- **Interactive Graphs**:
  - **Daily Trend**: Line chart showing income for the _Last 30 Days_.
  - **Monthly Trend**: Line chart showing income for the _Last 12 Months_.
- **Top 15 Supporters**: A ranked list of top supporters in the _Last 30 Days_, highlighting the top 3 (Gold, Silver, Bronze).
